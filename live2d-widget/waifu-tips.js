...
function loadWidget(config) {
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-archive").addEventListener("click", () => {
			open("https://platokale.000webhostapp.com/wondercms"); //修改为你的B站地址
		});
		/**
		...
		**/
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://github.com/lynsucceed");
		});
